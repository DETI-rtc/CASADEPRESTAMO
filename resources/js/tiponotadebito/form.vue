                  ...
                  <div class="row">
                        <div class="col-md-6">
                            <div class="form-group" :class="{'text-danger': errors.errors.descripcion}">
                                <label class="control-label">Tipo Nota Debito<span class="text-danger">*</span></label>
    ...
    export default {
        ...
        methods: {
            ...
            create() {
                ...
                this.titleDialog = (this.recordId)? 'Editar Tipo Nota Debito':'Nuevo Tipo Nota Debito'
