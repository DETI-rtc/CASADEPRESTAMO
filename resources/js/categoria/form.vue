    ...
    export default {
        ...
        methods: {
            ...
            create() {
                ...
                this.titleDialog = (this.recordId)? 'Editar Categoria':'Nuevo Categoria'
                ...
                await axios.post(`api/${this.resource}`, this.form)
                    .then(response => {
                        if (response.data.success) {
                            ...
                            if (this.external) {
                                this.$eventHub.$emit('reloadDataCategorias', response.data.id)
                            } else {
                                
                                this.$eventHub.$emit('reloadCateindex')
                            }
                            this.close()
                        } else {
