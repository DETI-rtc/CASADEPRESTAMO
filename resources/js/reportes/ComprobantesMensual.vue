    ...
    <div class="card" style="border:none;">
        ...
        <div class="card-body">
            ...
            <table class="table">
                <thead>
                    <tr>
                        <th colspan="10" class="text-center pt-0 mt-0 pb-0" style="border:none"><span style="font-size:13px; font-weigth:bolder; text-transform: uppercase;">RECAUDACIONES CONSOLIDADAS - CASA DE PRESTAMOS HUANCAYO</span></th>
                    </tr>
                    <tr>
                ...
                <tbody>
                    <tr v-for="(com, i) in comprobantes">
                        <template v-if="i+1 < comprobantes.length">
                            <td class="tds text-center">{{com.fecha_emision | myDate}}</td>
