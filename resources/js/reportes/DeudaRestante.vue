       ...
       <div class="card card-info">
        ...
        <div  ref="contento" >
              <div class="text-center">
                ...
                <div class="input-group mb-3 col-6 no-print">
              ...
              <div class="text-center">
                ...
                <tbody v-if="data.length > 0">
                  ...
                  <tr style="font-weight: bold;">
                    ...
                    <td class="text-right"> {{totalredon | decimal1}} </td>
              ...
              data.map(i=>{
                ...
                i.monto_res=i.monto_res-i.adelanto;
                  ...
                  if(i.redondeo === null){
                    ...
                    i.total = parseFloat(i.total_pagado) + parseFloat(i.monto_cancelado) + i.adelanto;
                  }else{
                    if (i.redo > 0) {
                      i.total = parseFloat(i.total_pagado)  + parseFloat(i.monto_cancelado) + i.adelanto ;
                    }else{
                ...
                if (i.monto_cancelado > 0) {
                  this.total_deuda += 0;
                  i.nocobro = parseFloat(i.total_deuda) - (parseFloat(i.total_pagado)+parseFloat(i.monto_cancelado));
                  //i.redo=0;
                } else {
                  i.nocobro = 0;
                ...
                this.total_total += parseFloat(i.total_pagado) + parseFloat(i.monto_cancelado) + i.adelanto;
