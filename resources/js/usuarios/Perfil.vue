                  ...
                  <div class="active tab-pane" id="activity">
                        <form class="form-horizontal">
                                <div class="row">
                                          ...
                                          <div class="form-group  col-md-6">
                                              <label for="inputName" class="col-md-2 control-label">Apellidos</label>
                                          ...
                                          <div class="form-group  col-md-6">
                                              <label for="inputName" class="col-md-2 control-label">DNI</label>
                                          ...
                                          <div class="form-group col-md-6">
                                              <label for="password" class="col-md-12 control-label">Password (Si deja en blanco no se cambiar el password)</label>
