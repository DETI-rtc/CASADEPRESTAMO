        ...
        <div class="modal fade" id="addNew" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="addNewLabel"
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content" :class="!editmode ? 'card card-primary' : 'card card-success'">
                    <div class="card-header">
                        <h5 class="card-title" v-show="!editmode" id="addNewLabel">Nuevo Usuario</h5>
                        <h5 class="card-title" v-show="editmode" id="addNewLabel">Actualizar Usuario</h5>
                        <div class="card-tools">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-6">
                                    ...
                                    <select v-model="form.rol" class="form-control" name="rol">
                                        <option v-for="rol in roles" v-bind:value="rol.name"> {{ rol.name }}
                                        </option>
                                    </select>
                                </div>
            ...
            createUser() {
                ...
                this.form.post('api/user')
                    .then(({data}) => {
                        ...
                        Swal.fire(
                            'Creado',
                            'Usuario creado satisfactoriamente su token es '+data.token,
                            'success',
                        )
