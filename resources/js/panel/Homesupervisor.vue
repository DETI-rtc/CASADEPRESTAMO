        ...
        <div class="row">
          ...
          <div class="col-lg-2 col-md-6">
            ...
            <div class="small-box bg-warning">
              <div class="inner">
                <h3 class="mb-0 " >{{nroactividad}}</h3>

                <p class="mb-0 ">Nro de Visitas</p>
              </div>
              <div class="icon">
            ...
            <!-- /.card -->
              ...
              <div class="card-header">
                <h3 class="card-title">
                  ...
                  Historial de Creditos - Meta por Analistas
                </h3>
...
export default {
  ...
  methods: {
    ...
    loadUsers(){
      ...
      axios.get("api/parainiciosupe",{params:{'ano':this.anio}}).then(({ data }) => {
          this.nrocredito = data.nrocredito;
          this.mtocredito = data.mtocredito;
          this.nroactividad = data.nroactividad;
          this.nroagen = data.nroagen;
          this.mtopago = data.mtopago;

          }).catch(error => { this.error = error.response });
      axios.get("api/creditomessupe",{params:{'ano':this.anio}}).then(({ data }) => {(this.datacollection3 = data); }).catch(error => { this.error = error.response });
      axios.get("api/pagoscreditosupe",{params:{'ano':this.anio}}).then(({ data }) => {(this.datacollection1 = data.dato1);}).catch(error => { this.error = error.response });
      axios.get("api/creditomesanasupe",{params:{'ano':this.anio}}).then(({ data }) => {(this.creditoanalistas = data);}).catch(error => { this.error = error.response });
      axios.get("api/creditoporsupe",{params:{'ano':this.anio}}).then(({ data }) => {this.datacollection2 = data.grafico; this.valores=data.valores }).catch(error => { this.error = error.response });
    },
