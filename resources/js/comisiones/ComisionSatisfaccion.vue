       ...
       <div class="card card-info card-outline">
            <div class="card-header">
                <h3 class="card-title" style="font-size: 24px !important;"> <i class="fas fa-users mr-2" >
                  </i> Meta de Calidad de Proceso</h3>
            ...
            <div class="card-body" ref="contento" >
                      ...
                      <v-client-table :data="resumen" :columns="columna" :options="options"  id="#ttrabajador">
                        <div slot="porcentaje" slot-scope="{row}">
                          <span>{{ row.porcentaje = 100*(parseFloat(row.promedio)/10) }} %</span>
                        </div>
                      </v-client-table>
            </div>
        </div>
    ...
    export default {
        ...
        data() {
            return {
              ...
              calificaciones:[],
              columna:['nombre_analista','promedio','porcentaje'],  
              options: {
                        headings: {
                        ...
                        filterable: ['nombre_analista','promedio','porcentaje'],
                        texts: {
        ...
        methods: {
          ...
          get(){
            ...
            axios.get('/api/porcentajesatisfaccion',{params:{anio:this.anio, mes:this.mes}})
            .then(({data}) => {
              console.log(data);
              this.resumen = data;
            }).catch((err) => {
