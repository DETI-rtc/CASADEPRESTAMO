    ...
    <div class="">
        ...
        <div class="card card-info">
                    <div class="card-header">
                        <h3 class="card-title" style="font-size: 24px !important;"> <i class="fas fa-users mr-2" ></i> CANCELACION DE CREDITOS</h3>
                    ...
                    <div class="card-body" ref="contento" >
                            ...
                            <v-client-table :data="pagosDeudas" :columns="columna" :options="options"  id="#ttrabajador" v-else>
                                ...
                                <div slot="actions" slot-scope="{ row }">
                                    <div class="btn-group">
                                        <button type="button" class="btn btn-secondary btn-sm"  @click="editCancelPago(row,'view')"><i class="fas fa-eye"></i></button>
                ...
                <div class="modal-dialog modal-xl" role="document"  >
                    ...
                    <div class="modal-content" v-bind:class="classModalHeader">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn btn-success btn-sm"  @click="validarPago('valido')" v-if="formCPago.situacion == 'P'">Validar</button>
                            <button type="button" class="btn btn-danger btn-sm"  @click="validarPago('rechazar')" v-if="formCPago.situacion == 'P'">Rechazar</button>
                        </div>
                    </form>
    ...
    export default {
        ...
        methods:{
            ...
            validarPago( funcion){
                ...
                this.$confirm('Recuerde que solo va a poder validar una sola vez el pago, ¿Desea continuar?', 'Advertencia', {
                    confirmButtonText: 'Si, Continuar',
                    cancelButtonText: 'Cancelar',
                    type: 'warning'
                    }).then(() => {
                        this.loading = true;
                        axios.post('/api/validarpagoteso',{id: this.formCPago.id, funcion})
                        .then(({data}) => {
                            this.loading = false;
                            console.log(data);
                            this.getCreditosCancel();
                            $('#canPago').modal('hide');
                            this.$message({
                                type: 'success',
                            ...
                            this.loading = false;
                            this.$message.error('Intentelo nuevamente, ocurrió un error en el servidor.')
                        });
                        console.log('este');
                ...
                // axios.post('/api/validarpagoteso',{id: row.id, funcion})
                // .then(({data}) => {
                //     console.log(data);
                // }).catch((err) => {
                //     console.log(err);
            ...
            loadUsers(){        
                ...
                axios.get("/api/creditospendientes")
                .then(({ data }) => (this.creditospen = data))
            ...
            getCreditosCancel(){
                this.loading = true;
                this.pagosDeudas =[];
                axios.get('/api/getcredcancelteso')
                .then(({data}) => {
                    console.log(data);
                    this.loading = false;
            ...
            getProfilePhoto(){
                ...
                let avatar = (this.formCPago.vaucher.length > 200) ? this.formCPago.vaucher : "/storage/"+ this.formCPago.vaucher ;
                return avatar;
            },
        },
