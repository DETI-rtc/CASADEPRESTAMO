    ...
    <div class="">
       <div class="card card-teal" v-if="error.status != 403">
        <div class="card-header">
            <h3 class="card-title" style="font-size: 24px;"> <i class="fa fa-calendar nav-icon"></i> Plan de Trabajo Mensual</h3>
            
                <div class="card-tools">
                          <button class="btn btn-primary" @click="nuevoperio" >Ingresar Plan de Trabajo <i class="fas fa-user-plus fa-fw"></i></button>
                      </div>
