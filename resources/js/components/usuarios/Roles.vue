<template>
    <div class="">
       <div class="card card-outline card-primary" v-if="error.status != 403">
        <div class="card-header">
            <h3 class="card-title mb-0 mt-1">ROLES </h3>
    ...
    <div class="modal fade" id="nuevorol" tabindex="-1" role="dialog" aria-labelledby="addNewLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                ...
                <div class="card-header">
                    <h5 class="card-title mb-0 mt-1" v-show="!editmode" id="addNewLabel">Nuevo Rol</h5>
                    <h5 class="card-title mb-0 mt-1" v-show="editmode" id="addNewLabel">Actualizar Rol Info</h5>
                    <div class="card-tools">
                ...
                <div class="modal-body">
                   ...
                   <!-- <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="custom-control custom-checkbox custom-control-inline" v-for="permisos in permi" v-bind:key="permisos.id">
