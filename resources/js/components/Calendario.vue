<template>
  <div class="container">
    <div class="justify-content-center">
      ...
      <div class="col-md-12">
        <Fullcalendar @eventClick="showEvent" :options="calendarPlugins" :events="events"/>
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  data() {
    return {
      calendarPlugins: {plugins: [ dayGridPlugin, interactionPlugin ],
  ...
  methods: {
    ...
    addNewEvent() {
      axios.post("/api/calendar", {...this.newEvent }).then(data => { this.getEvents(); // update our list of events
