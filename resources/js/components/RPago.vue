                        ...
                        <h3 class="card-title" style="font-size: 24px !important;"> <i class="fas fa-users mr-2" ></i> RELACION DE PAGOS </h3>
                            <div class="card-tools">
                                ...
                                <div class="btn-group" role="group">
                                     <el-select v-model="anio" filterable placeholder="Seleccione" @input="getCuotasAnio">
                                <el-option
                                ...
                                :value="peri.año">
                                    ...
                                    <button class="btn btn-warning btm-sm"  @click="openModalPago"> Registrar Pago <i class="fas fa-plus"></i></button>
                                    <button class="btn btn-success btm-sm"  @click="openModalN"> Registrar Pago N <i class="fas fa-plus"></i></button>
                                    <button class="btn btn-info btm-sm"  @click="openModalAmortizacion"> Amortizacion <i class="fas fa-plus"></i></button>
                                </div>
                            ...
                            <v-client-table :data="pagos" :columns="columna" :options="options"  id="#pagos">
                                    ...
                                    <div slot="acciones" slot-scope="{ row }">
                                        <div class="btn-group">
                                            ...
                                            <button type="button" class="btn btn-warning btn-sm" @click="openEditPago(row)"><i class="fas fa-edit"></i></button>
                                            <button type="button" class="btn btn-success btn-sm" @click="PagoCompro(row)"><i class="fas fa-edit"></i></button>
                                        </div>
                                    </div>
                                </v-client-table>
                    </div>
                            ...
                            <div class="col-6">
                                ...
                                <div class="form-group">
                                        ...
                                        <div class="form-group row  m-0">
                                            ...
                                            <div class="col-sm-6">
                                                 <label class="text.bold text-lg mt-2 mb-0 float-right" >{{formPago.monto = formPago.monto_efectivo + formPago.monto_desc}} </label>
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        <template v-if="nuevoCrono.cuotas.length > 0 && loadAmoGetCalc == false">
                                            <tr v-for="i in nuevoCrono.cuotas">
                                                <td> {{ i.cuotanro}} </td>
                                                <td> {{ i.fecha_venci}} </td>
    ...
    export default {
        ...
        data(){
            return {
                ...
                columna:['dni','clientes','cuopago','mon_pag','cappago','intpago','segpago','compago','ultimopago','acciones'],  
                options: {
                          headings: {
        ...
        methods:{
            PagoCompro(row){
                ...
                this.formModalEditPago.post('api/pagocompro')
                .then(({data}) => {
                    this.loading = false;
                    this.$notify({
                        title: 'Satisfactorio',
            ...
            amortizar(){
                ...
                axios.post('/api/amortizar',{montoAmortizar : this.montoAmortizar, idcredito:this.idcredito, cuotaspendientes:this.cuotaspendientes, tipo_amortizacion:this.tipoAmortiza})
                .then(({data}) => {
                    console.log(data);
                    this.loadAmoGetCalc = false;
                    this.nuevoCrono.cuotas=data;
                }).catch((err) => {
                    this.loadAmoGetCalc = false;
                    console.log(err);
                });
            ...
            guardarAmortizacion(cuotas){
                axios.post('/api/guardaramortizacion',{cuotas,cuotaspendientes : this.cuotaspendientes})
                .then(({data}) => {
                    console.log(data);
