    ...
    <div class="">
       <div class="card card-teal" v-if="error.status != 403">
        <div class="card-header">
            <h3 class="card-title" style="font-size: 24px;"> <i class="fa fa-calendar nav-icon"></i> PERIODOS</h3>
            
                <div class="card-tools">
                          <button class="btn btn-primary" @click="nuevoperio" >Agregar Periodo <i class="fas fa-user-plus fa-fw"></i></button>
                      </div>
                ...
                <div class="modal-body">
                   ...
                   <div class="row col-12">
                      <div class="form-group col-12" v-show="!editmode">
                                ...
                                <v-select  :options="persona" :reduce="persona => persona.id"  v-model="form.idpersona" label="apellidos" ></v-select>
                      </div>
    ...
    export default {
        data() {
            return {
                ...
                persona : [],
                asignameta:[],
                columna:['nombres','m1','m2','m3','m4','m5','m6','m7','m8','m9','m10','m11','m12','anual','estado','actions'],  
                options: {
                          headings: {
        ...
        methods: {
            ...
            loadUsers(){        
                ...
                axios.get("api/user").then(({ data }) => (this.persona = data)).catch(error => { this.error = error.response });  
            },
            creaAsig(){
                //this.$Progress.start();
