    ...
    export default {
        ...
        data() {
            return {
                ...
                tipos:[],
                recordId: null,
                columna: [ 'id','descripcion','letra','codigo','nombre','tipo','acciones'],
                options: {
                    headings: {
                        id: 'ID',
                        descripcion: 'Tipo afectacion',
                        letra: 'Letra',
                        codigo:'Codigo',
                        nombre:'Nombre',
                        tipo:'Tipo',
        ...
        created() {
            this.title = 'Tipos Afectaciones'
            axios.get(`/api/tipoafecta`).then((response) => {
