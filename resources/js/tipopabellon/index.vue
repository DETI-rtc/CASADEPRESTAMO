            ...
            <div class="card-body">
                <v-client-table class="tableuser" :data="tipos" :columns="columna" :options="options">
                    ...
                    <div slot="acciones" slot-scope="{ row }">
                                 ...
                                 <button type="button" class="btn waves-effect waves-light btn-xs btn-success" @click.prevent="clickCreate(row.id)" ><i class="fas fa-edit"></i> Editar</button>
...
<script>
    ...
    export default {
        ...
        created() {
            this.title = 'Tipos Pabellon'
            axios.get(`/api/tipopabe`).then((response) => {
