                  ...
                  <div class="row">
                        <div class="col-md-6">
                            <div class="form-group" :class="{'text-danger': errors.errors.nombre}">
                                <label class="control-label">Tipo Pabellon<span class="text-danger">*</span></label>
    ...
    export default {
        ...
        methods: {
            ...
            create() {
                ...
                this.titleDialog = (this.recordId)? 'Editar Tipo Pabellon':'Nuevo Tipo Pabellon'
                ...
                await axios.post(`api/${this.resource}`, this.form)
                    .then(response => {
                        if (response.data.success) {
                            ...
                            if (this.external) {
                                this.$eventHub.$emit('reloadDataTipopabe', response.data.id)
                            } else {
