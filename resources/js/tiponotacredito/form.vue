                  ...
                  <div class="row">
                        <div class="col-md-6">
                            <div class="form-group" :class="{'text-danger': errors.errors.descripcion}">
                                <label class="control-label">Tipo Nota Credito<span class="text-danger">*</span></label>
    ...
    export default {
        ...
        methods: {
            ...
            create() {
                ...
                this.titleDialog = (this.recordId)? 'Editar Tipo Nota Credito':'Nuevo Tipo Nota Credito'
