                ...
                <div class="row">
                                ...
                                <div id="custom-input">
                                    <el-select :disabled="recordItem != null"
                                        ...
                                        <el-tooltip v-for="option in items"  :key="option.id" placement="top">
                                            <div slot="content">
                                                Unidad: {{option.unidad}} <br>
                                                Afectación: {{option.afectacion}} <br>
                                                Stock: {{option.stock_ini}} <br>
                                                Precio: S/. {{option.valor_unitario}} <br>
                                            </div>
                                            <el-option  :value="option.id" :label="option.nombre"></el-option>
                                        </el-tooltip>
                                    </el-select>
                    ...
                    <div class="col-md-4 col-sm-4">
                        <div class="form-group" :class="{'has-danger': errors.unit_price_value}">
                            ...
                            <el-input v-model="form.unit_price_value" @input="calculateQuantity" :readonly="typeUser != 'admin'">
                    ...
                    <div v-if="edit_name_product" class="col-md-12 col-sm-12 mt-2">
                        <div class="form-group">
                    ...
                    <!-- <template v-if="!is_client">
                        ...
                        <div class="col-md-12"  >
                            <div style="margin:3px" class="table-responsive">
                                ...
                                <tbody>
                                <tr v-for="(row, index) in form.item_unit_types" v-bind:key="index">
                                ...
                                <el-collapse-item :disabled="recordItem != null" title="+ Agregar Descuentos/Cargos/Atributos especiales" name="1">
                                    <div >
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                            <tr v-for="(row, index) in form.discounts" v-bind:key="index">
                                                <td>
                                        ...
                                        <div >
                                            ...
                                            <table class="table">
                                                ...
                                                <tbody>
                                                <tr v-for="(row, index) in form.attributes" v-bind:key="index">
                                                    <td>
...
<script>
    ...
    import ItemForm from '../../producto/form.vue'
    ...
    export default {
        props: ['recordItem','showDialog', 'operationTypeId', 'currencyTypeIdActive', 'exchangeRateSale', 'typeUser',
                'isEditItemNote', 'edit_name_product', 'documentTypeId', 'noteCreditOrDebitTypeId'],
        ...
        created() {
            this.initForm()
            axios.get(`/api/${this.resource}/tablas`).then(response => {
        ...
        methods: {
            ...
            async searchRemoteItems(input) {
                if (input.length > 2) {
                    ...
                    await axios.get(`/api/${this.resource}/search-items/`, { params })
                            .then((response) => {
            ...
            async create() {
                ...
                this.affectation_igv_types = await _.filter(this.all_affectation_igv_types, {exportation: 0})
            ...
            async regularizeLots(){
                ...
                if(this.form.document_item_id ){

                    await axios.get(`/${this.resource}/regularize-lots/${this.form.document_item_id}`).then((response) => {
            ...
            async changeItem() {
                ...
                this.form.unit_price_value = this.form.item.valor_unitario;
                // this.lots = this.form.item.lots
                this.form.document_item_id = this.form.item.id;
                this.form.has_igv = this.form.item.idtipoafectacion;
                // this.form.has_plastic_bag_taxes = this.form.item.has_plastic_bag_taxes;
                this.form.affectation_igv_type_id = this.form.item.idtipoafectacion;
            ...
            async reloadDataItems(item_id) {
                ...
                if(!item_id){
                    ...
                    await axios.get(`/api/${this.resource}/table/items`).then((response) => {
                    ...
                    await axios.get(`/api/${this.resource}/search/item/${item_id}`).then((response) => {
