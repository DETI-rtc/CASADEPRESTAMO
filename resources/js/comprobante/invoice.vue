                        ...
                        <div class="row">
                            ...
                            <div v-show="form.document_type_id > 2" class="col-lg-2">
                                <div class="form-group" :class="{'has-danger': errors.tipo_comprobante_ref_id}">
                                    ...
                                    <el-select v-model="form.tipo_comprobante_ref_id_1" @change="selectComprobanteEmitido" filterable class="border-left rounded-left">
                            ...
                            <div v-show="form.document_type_id > 2" class="col-lg-3">
                                <div class="form-group" :class="{'has-danger': errors.codmotivo}">
                                    ...
                                    <el-select v-model="form.codmotivo" class="border-left rounded-left" filterable>
                            ...
                            <div class="col-lg-3 pb-2">
                                <div class="form-group" :class="{'has-danger': errors.customer_id}">
                                    ...
                                    <el-select v-model="form.customer_id" filterable remote class="border-left rounded-left" popper-class="el-select-customers"
                                        ...
                                        <el-option v-for="option in customers" :key="option.id" :value="option.id" :label="option.nom_comp"></el-option>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            changeDateOfIssue() {
              let minDate = moment().subtract(8, 'days')
            ...
            async submit() {
                ...
                if (this.form.tipo_comprobante_ref_id_1) {
                    let comprobante = this.compemitidos.find(i => i.id == this.form.tipo_comprobante_ref_id_1);
